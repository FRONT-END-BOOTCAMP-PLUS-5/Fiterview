...
export default function CheckList() {
  return (
    <>
      <ul className="mt-[20px] gap-[11px] flex flex-col select-none cursor-default">
        <li>
        ...
        <div className="flex items-center gap-[12px]">
          ...
          <p className="text-[15px] text-[#334155] select-none cursor-default">
            조용한 환경에서 면접을 진행할 수 있습니다.
          </p>
        </div>{' '}
        <div className="flex items-center gap-[12px]">
          <div className="w-[20px] h-[20px] bg-[#E2E8F0] rounded-[4px]"></div>
          <p className="text-[15px] text-[#334155] select-none cursor-default">
            안정적인 인터넷 연결 상태를 확인했습니다.
          </p>
        </div>
      </ul>
    </>
