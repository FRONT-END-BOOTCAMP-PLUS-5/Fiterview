...
export function NoneUploadFiles() {
  return (
    <div className="h-97 self-stretch bg-white rounded-lg outline-1 outline-offset-[-1px] outline-gray-100 inline-flex flex-col justify-center items-center gap-3">
