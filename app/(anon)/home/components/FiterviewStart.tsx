  ...
  return (
    <div className="w-full px-28 py-20 bg-[#3B82F6] flex flex-col justify-start items-center gap-8">
      <div className="w-full flex flex-col justify-start items-center gap-6">
        ...
        <button className="h-14 px-8 bg-white rounded-[12px] flex justify-center items-center gap-2">
          <Start width={20} height={20} stroke="#3B82F6" strokeWidth={1.67} />
          <p className="text-[#3B82F6] text-[16px] font-semibold leading-tight">무료로 시작하기</p>
        </button>
      </div>
    </div>
  );
